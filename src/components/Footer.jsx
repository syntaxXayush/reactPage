...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen bg-white p-20 font-["Neue Montreal"]'>
        <div className='w-1/2 h-full flex flex-col justify-between '>
          <div className='heading'>
          <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-9.5'>Eye-</h1>
            <h1 className='text-[8vw] font-semibold uppercase leading-none -mb-9.5'>Opening</h1> 
          </div>
        ...
        <div className='w-1/2'>
        <h1 className='text-[6vw] font-semibold uppercase leading-none -mb-9.5'>Presentation
        </h1>
        <div className='dets font-mono mt-10'>
          ...
          <a className='block text-xl font-light' href='#'>Linkedln</a>
